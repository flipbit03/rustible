...
Everything below was run against a real machine: `cadumac.local`, Apple
...
```
[cadumac]    connected: aarch64-apple-darwin home /Users/cadu in 264.50ms
built mac for aarch64-apple-darwin in 95.83ms
[cadumac]    binary already cached (2451008 bytes) in 46.20ms
[cadumac]    Other("macos") on Aarch64, root=true
[cadumac]  sw_vers .................................... changed         $ /usr/bin/sw_vers   action
[cadumac]    ProductName: macOS | ProductVersion: 26.3 | BuildVersion: 25D125 |
[cadumac]  spike directory ............................ ok
[cadumac]  marker file ................................ ok
[cadumac]  host line .................................. ok
[cadumac]  fetch a known file over https .............. ok
[cadumac]    796 bytes over TLS
total 462.95ms
```
...
```
[cadumac]    HELPER commands run as cadu here and as root through the helper
[cadumac]  root-owned line through the helper ......... changed  as root
[cadumac]    STREAM hosts.kdl arrived at /var/folders/n6/…/T/.rustible-18d4a73…/1/hosts.kdl sha256 a4ad6cce…
[cadumac]  extract it with rustible's own extractor ... changed  extract /tmp/spike.tar.gz (tar.gz: 1 files, 1 dirs, …)
[cadumac]    ARCHIVE extracted: "hello"
[cadumac]    FETCH pulled a.txt back to the workspace
```
...
```
scutil --get HostName       CADUMAC
scutil --get LocalHostName  CADUMAC
scutil --get ComputerName   CADUMAC
```
...
```
cadumac$ cat /etc/sysctl.d/99-rustible.conf
kern.maxfiles = 49152
```
...
>
> ```
> FACTS os=Macos distro=Macos ver=26.3 kernel=25.3.0 host=CADUMAC
...
On `cadumac`, `playbooks/macbrew.rs`, unescalated:
...
group "mac" {
    host "cadumac" addr="cadumac.local" ssh_user="cadu"
}
KDL
...
hostname, which was restored to `CADUMAC`. `~/.cache/rustible` (18 MB of
